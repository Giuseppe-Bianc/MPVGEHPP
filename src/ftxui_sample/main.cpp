...
// configuration step. It creates a namespace called `MPVGEHPP`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MPVGEHPP::cmake::project_name, MPVGEHPP::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MPVGEHPP::cmake::project_version);
      return EXIT_SUCCESS;
    }
